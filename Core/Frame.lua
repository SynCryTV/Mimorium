...
function Mimorium:CreateMainFrame()
    ...
    instrumentButton:SetScript("OnClick", function()
        Mimorium:OpenInstrument("harp")
    end)

    local pianoButton = CreateFrame("Button", nil, frame, "UIPanelButtonTemplate")
    pianoButton:SetSize(190, 28)
    pianoButton:SetPoint("TOP", instrumentButton, "BOTTOM", 0, -8)
    pianoButton:SetText("Konzertklavier spielen")
    pianoButton:SetScript("OnClick", function()
        Mimorium:OpenInstrument("piano")
    end)
